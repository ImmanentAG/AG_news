module.exports = app => {
  ...
  router.delete("/newsitem/", newsitems.deleteAll);
    ...
    router.delete("/usertopicscores/", userTopicScoress.deleteAll);
        ...
        router.get("/categorypair/:newsItemID/:userID", CategoryPairs.findOne);
      
        // Update a Category Pair with id
        router.put("/categorypair/:newsItemID/:userID", CategoryPairs.update);
      
        // Delete a Category Pair with id
        router.delete("/categorypair/:newsItemID/:userID", CategoryPairs.delete);
